    ...
    <div class="mx-4 mt-2 z-0  max-w-4xl sm:ms-64 sm:ps-3 pb-5">
        ...
        <form method="POST" action="{{ route('super-admin.dokters.update', $dokter) }}" class="max-w-lg m-4">
            ...
            <div class="mt-3">
                ...
                <x-text-input id="nama" class="block mt-1 w-full" type="text" name="nama" :value="$dokter->getRawOriginal('nama')"
                    autocomplete="off" />
            ...
            <div class="mt-3">
                ...
                <x-text-input id="tempat_lahir" class="block mt-1 w-full" type="text" name="tempat_lahir"
                    :value="$dokter->tempat_lahir" autocomplete="off" />
            ...
            <div class="mt-3">
                ...
                <x-text-input id="tanggal_lahir" class="block mt-1 w-full" type="date" name="tanggal_lahir"
                    :value="$dokter->tanggal_lahir" autocomplete="off" />
                <x-input-error :messages="$errors->get('tanggal_lahir')" class="mt-2" />
            </div>

            <div class="mt-3">
                <x-input-label for="no_hp" value="No Whatsapp" />
                <x-text-input id="no_hp" class="block mt-1 w-full" type="text" name="no_hp" :value="$dokter->no_hp"
                    autocomplete="off" />
                <x-input-error :messages="$errors->get('no_hp')" class="mt-2" />
            </div>
            <div class="mt-3">
                <x-input-label for="nik" value="NIK" />
                <x-text-input id="nik" class="block mt-1 w-full" type="text" name="nik" :value="$dokter->nik"
                    autocomplete="off" />
                <x-input-error :messages="$errors->get('nik')" class="mt-2" />
            </div>
            <div class="mt-3">
                <x-input-label for="alamat" value="Alamat" />
                <x-text-input id="alamat" class="block mt-1 w-full" type="text" name="alamat" :value="$dokter->alamat"
                    autocomplete="off" />
